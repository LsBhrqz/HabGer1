...
\begin{document}
	...
	NO OLVIDAR COLOCAR LA FUENTE (Porfa pásame el enlace Iván)\\
	
	Por motivos prácticos se decidió hacer un análisis sólo de la alta gerencia de SURA y a los principales encargados del sector financiero. En la imagen REFERENCIA se muestra el diagrama organizativo que se analiza en este informe.
	...
	\subsubsection{Principios corporativos}
	\begin{itemize}
	...
	ENLACE PARA LA REFERENCIA: https://seguros.sura.cl/compania/principios
	OTRA REFERENCIA: %https://www.epssura.com/embarazo-menuparalasmamas-229/preguntas-frecuentes-durante-el-embarazo-menuparalasmamas-233?task=section&id=29
	...
	REFERENCIA: https://www.epssura.com/valores-corporativos-menu-boletin2-243
	...
	A pesra de que ya se han realizado críticas a lo largo del documento se condensan las críticas y se añaden las sugerencias en términos de estructura y estilo de administración  en este apartado: 
	
	\begin{itemize}
		\item Se considera que debe hacer una modificación al organigrama porque coincide con una etsructura organizacional funcional pero a nivel prático llega a ser matricial.
		...
		\item Podrían contratar a más personas en los procesos administrativos que sean mpas lentos para que no les perjudique tanto la burocracia.
		\item Mantener un seguimiento de la salud mental de los trabajadores para supervisar y prevenir que no haya un mal ambiente laboral o contratar un piscólogo que pueda mediar los conflictos cunado se presenten.
